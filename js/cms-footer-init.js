// ==========================================================================
// CMS INITIALIZATION FOR FOOTER
// ==========================================================================

document.addEventListener('DOMContentLoaded', function() {
    console.log('Inicializando CMS para footer...');
    
    // Initialize CMS data for footer
    initializeFooterCMS();
});

async function initializeFooterCMS() {
    try {
        ...
        for (const section of sections) {
            try {
                const response = await fetch(CMS_CONFIG.apiUrls.loadSection(section));
        ...
        console.log('Inicialización del CMS de footer completada');
        
    } catch (error) {
        console.error('Error durante la inicialización del CMS de footer:', error);
    }
}
